    ...
    20: function(e, t, a) {
        ...
        e.exports = {
            ...
            updateData: function(isFirst) {
                ...
                var url = "dataGenerator/prices.php";
                ...
                l.abort(), l = $.ajax({
                    ...
                    success: function(t) {
                        ...
                        var valb = parseFloat(val.p);
                                var vala = parseFloat(val.cp);
                               
                                nodes[prop] = isNaN(vala) ? null : parseFloat(vala);
                               
                               
                                additional[prop] =(valb);
                ...
                return d(e, [{
                    ...
                    value: function(e, t) {
                        ...
                        if (navigator.userAgent.indexOf('Chrome') > -1) {
                            e.nameFontSize = Math.max(e.nameFontSize, 8);
                        }
    ...
    59: function(e, t, a) {
        ...
        window.FinvizInitSmallCanvas = function(e, t, a) {
            function d() {
                ...
                if ("geo" == t)
                    for (b.strokeStyle = n.background, b.textBaseline = "alphabetic", b.textAlign = "left", b.fillStyle = "#3c404b", b.font = "normal " + n.industryFontSize + "px sans", e = 0, i = s.industries.length; e < i; e++) a = s.industries[e], b.fillStyle = "#e0e0e0", a.dx > 40 && a.dy, b.fillRect(a.x, a.y + 3, a.dx - 1, a.dy - 4);
                for (e = 0; e < f; e++) a = s.nodes[e], a.perfText = "", void 0 !== a.additional && null !== a.perfText ? a.perfText = a.additional : void 0 !== a.perf && null !== a.perf && (a.perfText = (a.perf > 0 ? "+" : "") + a.perf.toFixed(2) + (a.dx > 32 ? "%" : "")), b.fillStyle = h(a.perf), b.fillRect(a.x, a.y, a.dx - 1, a.dy - 1), s.setIdealFontSize(a, p);
                for (b.textBaseline = "middle", b.textAlign = "center", b.fillStyle = "rgba(0, 0, 0, 0.5)", e = 0; e < f; e++) a = s.nodes[e], "block" === a.nameOpacity && (c = a.x + a.dx / 2 + 1, d = a.y + a.dy / 2 + 1, "block" === a.perfOpacity && (d -= .5 * a.nameFontSize), b.font = "normal " + a.nameFontSize + "px sans", b.fillText(a.name, c, d));
                for (b.fillStyle = "rgba(255, 255, 255, 1)", e = 0; e < f; e++) a = s.nodes[e], "block" === a.nameOpacity && (c = a.x + a.dx / 2, d = a.y + a.dy / 2, "block" === a.perfOpacity && (d -= .5 * a.nameFontSize), b.font = "normal " + a.nameFontSize + "px sans", b.fillText(a.name, c, d));
                for (b.fillStyle = "rgba(0, 0, 0, 0.5)", e = 0; e < f; e++) a = s.nodes[e], "block" === a.perfOpacity && (c = a.x + a.dx / 2 + 1, d = a.y + a.dy / 2 + 1 + .5 * a.nameFontSize, b.font = "normal " + a.perfFontSize + "px sans", b.fillText(a.perfText, c, d));
                for (b.fillStyle = "rgba(255, 255, 255, 1)", e = 0; e < f; e++) a = s.nodes[e], "block" === a.perfOpacity && (c = a.x + a.dx / 2, d = a.y + a.dy / 2 + .5 * a.nameFontSize, b.font = "normal " + a.perfFontSize + "px sans", b.fillText(a.perfText, c, d));
            ...
            l = React.createClass({
                ...
                renderHover: function(e) {
                    ...
                    if (e.save(), e.clearRect(0, 0, a, n), e.translate.apply(e, t.zoom.translate()), e.scale(t.zoom.scale(), t.zoom.scale()), i) {
                        ...
                        if (e.stroke(), f = r, e.translate(-.5, -.5), f.dx > 40 && f.dy > 12 && (e.beginPath(), e.moveTo(f.x + .5, f.y), e.lineTo(f.x + .5, f.y + d.industryFontSize + 1.5), void 0 !== f.perf && null !== f.perf && (e.lineTo(f.x + 6, f.y + d.industryFontSize + 1.5), e.lineTo(f.x + 11, f.y + d.industryFontSize + 1.5 + 5), e.lineTo(f.x + 16, f.y + d.industryFontSize + 1.5)), e.lineTo(f.x + f.dx - 1.5, f.y + d.industryFontSize + 1.5), e.lineTo(f.x + f.dx - 1.5, f.y), e.fill(), e.stroke()), e.translate(.5, .5), e.lineWidth = 3, e.strokeRect(f.x, f.y, f.dx - 1, f.dy - (f.dx > 40 && f.dy > 12 ? 1 : 4)), e.textBaseline = "alphabetic", e.textAlign = "left", e.fillStyle = "#6b5811", e.font = "normal " + d.industryFontSize + "px sans", f.dx > 40 && f.dy > 12) {
                ...
                renderCanvas: function(e, t) {
                    ...
                    if ("geo" !== i)
                        for (e.fillStyle = d.sectorColor, e.font = "700 " + d.sectorFontSize + "px sans", o = 0, b = t.sectors.length; o < b; o++) s = t.sectors[o], e.fillText(s.name.toUpperCase(), s.x + 2 * d.padding.left + d.sectorPaddingLeft, s.y + d.sectorFontSize - 1);
                    var h = d.scaleStepFormat[c.getScaleId()],
                        p = d.scaleMinMax[c.getScaleId()],
                        m = p[0] >= 0 && p[1] >= 0;
                    for (o = 0; o < u; o++) s = t.nodes[o], s.perfText = "", s.perfText =  s.perf.toFixed(2)+"%" , e.fillStyle = t.colorScale(s.perf), e.fillRect(s.x, s.y, s.dx - 1, s.dy - 1), t.setIdealFontSize(s, r);
                    for (e.textBaseline = "middle", e.textAlign = "center", e.fillStyle = "rgba(0, 0, 0, 0.5)", o = 0; o < u; o++) s = t.nodes[o], "block" === s.nameOpacity && (f = s.x + s.dx / 2 + 1, l = s.y + s.dy / 2 + 1, "block" === s.perfOpacity && (l -= .5 * s.nameFontSize), e.font = "normal " + s.nameFontSize + "px sans", e.fillText(s.name, f, l));
                    for (e.fillStyle = "rgba(255, 255, 255, 1)", o = 0; o < u; o++) s = t.nodes[o], "block" === s.nameOpacity && (f = s.x + s.dx / 2, l = s.y + s.dy / 2, "block" === s.perfOpacity && (l -= .5 * s.nameFontSize), e.font = "normal " + s.nameFontSize + "px sans", e.fillText(s.name, f, l));
                    for (e.fillStyle = "rgba(0, 0, 0, 0.5)", o = 0; o < u; o++) s = t.nodes[o], "block" === s.perfOpacity && (f = s.x + s.dx / 2 + 1, l = s.y + s.dy / 2 + 1 + .5 * s.nameFontSize, e.font = "normal " + s.perfFontSize + "px sans", e.fillText(s.perfText, f, l));
                    for (e.fillStyle = "rgba(255, 255, 255, 1)", o = 0; o < u; o++) s = t.nodes[o], "block" === s.perfOpacity && (f = s.x + s.dx / 2, l = s.y + s.dy / 2 + .5 * s.nameFontSize, e.font = "normal " + s.perfFontSize + "px sans", e.fillText(s.perfText, f, l));
                    ...
                    for (e.textBaseline = "alphabetic", e.textAlign = "left", e.fillStyle = d.sectorColor, e.font = "normal " + d.industryFontSize + "px sans", o = 0, b = t.industries.length; o < b; o++)
                ...
                _onShareMapClick: function(e) {
                    ...
                    s.src = d.logoBase64, s.onload = function() {
                        ...
                        r.textBaseline = "middle", r.textAlign = "right", r.font = "9pt sans", r.fillStyle = "#4c5261", r.drawImage(s, 2, 4);
                        var d = t,
            ...
            r = React.createClass({
                ...
                render: function() {
                    ...
                    return React.createElement("div", {
                        ...
                        className: "price"
                    }, t.additional), React.createElement("td", {
                        className: "change"
                        ...
                        return React.createElement("tr", {
                            ...
                            className: "price"
                        }, c && d[d.length - 1] ? d[d.length - 1].toFixed(2) : t.additional), React.createElement("td", {
                            className: "change",
                            style: {
                                color: r(t.perf)
                            }
