...
function drawMap(color, ignoreAuth) {
    ...
    $.getJSON("dataGenerator/generateData.php", function(result) {
...
$(function() {
    ...
    var color1dArr = ['#00d641', '#00bd39', '#009e30', '#008729', '#006920', '#690808', '#870c0c', '#ab0e0e', '#c91010', '#e41414'].reverse(), //涨跌幅1日颜色
        ...
        valueRange1dArr = ['-5%','-4%', '-3%', '-2%', '-1%', '1%', '2%', '3%', '4%', '5%'], //图例1日涨跌幅数值
        ...
        valueRangeEdArr = ['Before earnings date', 'After earnings date'], //业绩公布日
